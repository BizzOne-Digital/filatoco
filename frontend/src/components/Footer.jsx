  ...
  <footer className="border-t border-beige bg-cream">
    <div className="mx-auto grid max-w-7xl grid-cols-2 gap-10 px-5 py-14 md:grid-cols-5 md:px-8">
      <div className="col-span-2">
        ...
        <p className="mt-3 max-w-xs text-sm text-brown/85">
      ...
      <div>
        ...
        <ul className="mt-4 space-y-2 text-sm text-brown/85">
    ...
    <div className="border-t border-beige px-5 py-6 md:px-8">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 md:flex-row">
        <p className="text-xs text-brown/80">© {new Date().getFullYear()} FilatoCo.ca. All rights reserved.</p>
        <div className="flex gap-4 text-brown/85">
