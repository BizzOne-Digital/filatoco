  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-xl px-5 py-20 text-center md:px-8">
        ...
        <p className="mt-3 text-brown/85">Your handmade order has been received.</p>
        <p className="mt-1 text-sm text-brown/70">Order Number: <strong>{order.orderNumber}</strong></p>
        <p className="mt-6 text-sm text-brown/80">A confirmation email has been sent to {order.customer.email}. We'll notify you as your bag is lovingly prepared.</p>
