      ...
      <div className="mx-auto max-w-5xl px-5 py-16 md:px-8">
        ...
        <Reveal delay={0.1} className="mt-10 grid items-center gap-10 md:grid-cols-2">
          ...
          <div className="space-y-4 text-brown/85">
            <h2 className="font-heading text-3xl text-brown">Where FilatoCo Began</h2>
        ...
        <Reveal delay={0.1} className="mt-16 grid items-center gap-10 md:grid-cols-2">
          <div className="order-2 space-y-4 text-brown/85 md:order-1">
            <h2 className="font-heading text-3xl text-brown">From Teaching to Handmade Creativity</h2>
            ...
            <h2 className="pt-2 font-heading text-3xl text-brown">Creating Peace Through Craft</h2>
        ...
        <Reveal delay={0.1} className="mt-16 grid items-center gap-10 md:grid-cols-2">
          ...
          <div className="space-y-4 text-brown/85">
            <h2 className="font-heading text-3xl text-brown">One-of-a-Kind Designs</h2>
